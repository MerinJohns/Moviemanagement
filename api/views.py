...
class MovieListCreateView(APIView):
    ...
    def get(self,request,*args,**kwargs):
        ...
        serializer_instance=MovieSerializer(qs,many=True) #serialization process happens here
    ...
    def post(self,request,*args,**kwargs):
        ...
        if serializer_instance.is_valid():
            ...
            serializer_instance.save() #bcz our serializer is model serializer
...
class MovieRetrieveUpdateDestroyView(APIView):
    ...
    def get(self,request,*args,**kwargs):
        ...
        #movie_obj is a model instance we have convert instance to python native
...
class LanguagesView(APIView):
    ...
    def get(self,request,*args,**kwargs):
        ...
        qs=Movie.objects.all().values_list("language",flat=True).distinct() #list
...
class GenreView(APIView):
    ...
    def get(self,request,*args,**kwargs):
        ...
        qs=Movie.objects.all().values_list("genre",flat=True).distinct() #list
...
class AlbumViewSet(viewsets.ModelViewSet):
    ...
    def add_track(self,request,*args,**kwargs):
        ...
        serializer_instance=TrackSerializer(data=request.data) #deserialize
